...
6. Check the connectivity to hipstershop application. `https://hipstershop.<LabName>.training.tigera.ca` via your browser.
...
> ## You have completed `6.Use Calico Observability to troubleshoot connectivity issues` lab. Next lab:  [7. Configure Calico Compliance Reporting](https://github.com/tigera-cs/Calico-Security-Observability-Troubleshooting-Training/blob/main/modules/7.%20Configure%20Calico%20Compliance%20Reporting/README.md) 
