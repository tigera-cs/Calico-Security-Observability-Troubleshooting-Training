...
> ## You have completed `6.Use Calico Observability to troubleshoot connectivity issues` lab. Next lab:  [6.Use Calico Observability to troubleshoot connectivity issues](https://github.com/tigera-cs/Calico-Security-Observability-Troubleshooting-Training/blob/main/modules/7.%20Configure%20Calico%20Compliance%20Reporting/README.md) 
